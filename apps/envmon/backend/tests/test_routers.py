...
async def test_list_plants():
    async def mock_sql_fn(token, sql, params=None, **kwargs):
        ...
        if "SELECT" in s and ("P.PLANT_ID" in s or "P.PLANT_NAME" in s):
            return [{"PLANT_ID": "P225", "PLANT_NAME": "Seville", "COUNTRY_ID": "ES", "REGION": "EMEA", "CITY": "Seville", "lat": 37.4, "lon": -5.9}]
