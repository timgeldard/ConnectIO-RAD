...
from processorderhistory_backend.db import run_sql_async, silver_tbl, sql_param, tbl, tz_date
from processorderhistory_backend.config.vessel_capacity import check_capacity
from processorderhistory_backend.production_planning.domain.vessels import (
    AVAILABLE_KEYWORDS,
    DIRTY_KEYWORDS,
    IN_USE_KEYWORDS,
...
def _derive_planning_data(
    ...
    ``processorderhistory_backend.config.vessel_capacity``).  When an order quantity is unknown (currently
