...
ROOT = Path(__file__).resolve().parents[1] / "processorderhistory_backend"
...
def test_domain_layer_isolation() -> None:
    ...
    """
    forbidden_prefixes = ("fastapi", "processorderhistory_backend.schemas", "processorderhistory_backend.db", "shared_db", "shared_auth")
    offenders = []
