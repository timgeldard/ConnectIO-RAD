...
export const POH_MODULES: ConnectIOModule[] = [
  ...
  },
  {
    ...
    tabs: [],
    landingCard: {
      tag: 'Production floor wallboard',
      desc: 'Live line status, running orders, downtime, next orders, and line-side stock for production wallboards.',
      stats: [
        { value: '—', label: 'Lines active' },
    ...
    i18nNamespace: 'poh.lineside-monitor',
    isUserSelectable: true,
    isPinnedByDefault: false,
    isMandatory: false,
    backendPrefix: '/api',
...
export const POH_COMPOSITION: AppComposition = {
  ...
  enabledModules: [
    ...
    'pours', 'day-view', 'lineside-monitor', 'yield', 'quality-analytics', 'equipment-insights', 'equipment-insights-2',
  ],
