...
import type { ChartDataPoint, ExcludedPoint } from '../types'
...
describe('SPC exclusions helpers', () => {
  ...
  it('uses stratify_value as part of the persisted exclusion identity', () => {
    const stratifiedPoints: ChartDataPoint[] = [
      { batch_id: 'B1', batch_seq: 1, sample_seq: 1, batch_date: '2024-01-01', plant_id: 'P1', stratify_value: 'OP-A', value: 10 },
      { batch_id: 'B1', batch_seq: 1, sample_seq: 1, batch_date: '2024-01-01', plant_id: 'P1', stratify_value: 'OP-B', value: 11 },
    ]
    const excludedPoints: ExcludedPoint[] = [
      { batch_id: 'B1', sample_seq: 1, plant_id: 'P1', stratify_value: 'OP-B' },
    ]
    expect(mapExcludedPointsToIndices(stratifiedPoints, excludedPoints)).toEqual([1])
  })
