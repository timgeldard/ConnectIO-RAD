"""Domain tests for quality status normalization rules."""

from trace2_backend.quality_record.domain.status import normalize_quality_status, batch_status_from_quality_stock
