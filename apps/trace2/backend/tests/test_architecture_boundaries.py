"""Architecture guardrails for the Trace2 DDD structure."""
...
ROOT = Path(__file__).resolve().parents[1] / "trace2_backend"
...
def test_domain_layer_isolation() -> None:
    ...
    """
    forbidden_prefixes = ("fastapi", "trace2_backend.schemas", "trace2_backend.utils.db", "shared_db", "shared_auth")
    offenders = []
...
def test_router_layer_isolation() -> None:
    ...
    business logic to the application layer. Exceptions allowed for the shim router.
    """
    offenders = []
