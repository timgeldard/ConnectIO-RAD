...
const docsCopy = {
  en: {
    ...
    personas: [
      ['Niamh Murphy', 'Warehouse Manager', 'NM', 'slate', 'Hit today’s OTIF. No fire-fighting before 08:30 stand-up.', '“I find out about a short-pick when the lorry is at the gate.”', 'OTIF, DIFOT, staging punctuality, stock accuracy'],
  ...
  fr: {
    ...
    personas: [
      ['Niamh Murphy', "Responsable d'entrepôt", 'NM', 'slate', "Atteindre l'OTIF du jour. Pas d'urgence avant le point 08:30.", "« J'apprends une rupture de picking quand le camion est à la porte. »", 'OTIF, DIFOT, ponctualité préparation, exactitude stock'],
