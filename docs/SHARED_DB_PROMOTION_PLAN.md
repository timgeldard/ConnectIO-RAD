...
7. `docs/shared-db.md`, `docs/shared-db-quickstart.md`, `docs/adr/007-shared-db-as-canonical-data-access.md`, and `libs/shared-db/CHANGELOG.md` exist and are linked from `docs/INDEX.md` and `ARCHITECTURE.md`.
