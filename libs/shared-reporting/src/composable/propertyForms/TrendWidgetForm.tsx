...
/** Props for the TrendWidgetForm component. */
export interface TrendWidgetFormProps extends PropertyFormProps<TrendChartWidgetProps> {
...
/**
 * Property form for configured Trend Chart widgets.
 * Supports static points and live data binding.
 * 
